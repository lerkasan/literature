...
public class AmazonBookSearch {
	 ...
	 */
	private static final String AWS_ACCESS_KEY_ID = "my_access_key_id";

	/*
	 * Your AWS Secret Key corresponding to the above ID, as taken from the AWS
	 * Your Account page.
	 */
	private static final String AWS_SECRET_KEY = "my_secret_key";
	...
	public static void main(String[] args) {
		 ...
		 */
		SignedRequestsHelper1 helper;
		try {
			helper = SignedRequestsHelper1.getInstance(ENDPOINT, AWS_ACCESS_KEY_ID, AWS_SECRET_KEY);
		} catch (Exception e) {
			e.printStackTrace();
			return;
		}
		...
		params.put("AssociateTag", "lerkasan-20");
